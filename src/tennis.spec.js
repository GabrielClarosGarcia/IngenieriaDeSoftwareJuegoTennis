...
describe("Tennis Scorer", () => {
  ...
  it("jugador 2 anota 4 veces jugador 1 en 0", () => {
    let tennis = new Tennis();
    tennis.player2Scores();
    tennis.player2Scores();
    tennis.player2Scores();
  ...
  it("jugador 1 y jugador 2 anotan 3 veces", () => {
    let tennis = new Tennis();
  ...
  it("Advantage jugador 1 y anota otra vez", () => {
    let tennis = new Tennis();
  ...
  it("Advantage jugador 2 y anota otra vez", () => {
    let tennis = new Tennis();
